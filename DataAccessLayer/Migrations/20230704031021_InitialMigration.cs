        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyNote_Customer_CustomerID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerNote_Company_CompanyID",
                        column: x => x.CompanyID,
                        principalTable: "Company",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Production_Company_CompanyID",
                        column: x => x.CompanyID,
                        principalTable: "Company",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Production_Customer_CustomerID",
                        column: x => x.CustomerID,
                        principalTable: "Customer",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Production_Offer_OfferID",
                        column: x => x.OfferID,
                        principalTable: "Offer",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyNote_CustomerID",
                table: "CompanyNote",
                column: "CustomerID");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerNote_CompanyID",
                table: "CustomerNote",
                column: "CompanyID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Production_CompanyID",
                table: "Production",
                column: "CompanyID");

            migrationBuilder.CreateIndex(
                name: "IX_Production_CustomerID",
                table: "Production",
                column: "CustomerID");

            migrationBuilder.CreateIndex(
                name: "IX_Production_OfferID",
                table: "Production",
                column: "OfferID");
        }
